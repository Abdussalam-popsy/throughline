 ...
 * Arc: worsening (sleep -> anxiety -> social withdrawal -> attendance) then
 * stabilising near the end. Peaks at "elevated" — never "crisis".
 * Written in first person, with concrete quotable lines for the brief.
 */
...
/**
 * Standalone entry used ONLY to demonstrate the crisis path in support.tsx.
 * Do NOT fold this into SEED_ENTRIES — the brief-send demo stays at "elevated".
 */
export const CRISIS_ENTRY: Entry = {
  id: "crisis-demo",
  date: "2026-06-05",
  text: "I don't see the point in any of this anymore and I've been thinking the world would be better without me in it.",
  riskLevel: "crisis",
  themes: ["crisis"],
  createdAt: 1748940000000,
};
